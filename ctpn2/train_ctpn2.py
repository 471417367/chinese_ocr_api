...
from ctpn2.utils.dataset import data_provider as data_provider
...
tf.app.flags.DEFINE_string('checkpoint_path', 'ctpn2/checkpoints_mlt/', '')
tf.app.flags.DEFINE_string('logs_path', 'ctpn2/logs_mlt/', '')
tf.app.flags.DEFINE_string('pretrained_model_path', 'ctpn2/data/vgg_16.ckpt', '')
